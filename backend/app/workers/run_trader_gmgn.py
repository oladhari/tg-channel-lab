...
SELL_COOLDOWN_SEC = int(os.getenv("GMGN_SELL_COOLDOWN_SEC", "45"))

TELEGRAM_API_ID = int(os.environ["TELEGRAM_API_ID"])
TELEGRAM_API_HASH = os.environ["TELEGRAM_API_HASH"]
SESSION_PATH = os.environ.get("TELEGRAM_SESSION_FILE") or os.environ.get("TELEGRAM_SESSION") or "tg_lab_session"
...
async def loop():
    ...
    print(f"[TRADER] GMGN target={GMGN_TARGET} strategy={LIVE_STRATEGY_KEY}")
